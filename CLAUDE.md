# CLAUDE.md — cloudsmith-monitoring

Claude Code context for `cloudsmith-monitoring` — one of the code repos in the CloudSmith open-source project.

## What this repo is

CloudSmith monitoring module — IMetricsBackend + ILogSearchBackend (VictoriaMetrics/Loki/Azure Monitor)
